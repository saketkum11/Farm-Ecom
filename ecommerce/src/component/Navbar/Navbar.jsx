...
return(<div>
    ...
    <nav class=" bg-green-7 text-color-0 pd-5 position-fixed t-0">
        <div class="wt-80  m-auto  flex items-center">
            <div class="text-xm">
                <Link class="text-dec text-color-0 text-m cursor" to="/">Farmgistic</Link>
            </div>
            ...
            <div class="m-lf">
                ...
                <ul class="style-none flex items-center">
                    <li class="pd-x-4">
                        <Link to="/login" target="_blank" className="text-dec text-color-0 pd-x-5 pd-y-3 bg-red-7">Login</Link>
                    </li>
                    ...
                    <li class="pd-x-4 flex  items-center position-rel justify-center">
                        <Link to="/wishlist" target="_blank" className="text-dec text-color-0 cursor"><i
                            class="fa-solid  fa-heart text-color-0"></i></Link>
                        <span
